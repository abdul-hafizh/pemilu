                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="p-2 mt-4">
                                    <form action="auth.php" method="post">
                                        ...
                                        <div class="mb-3">
                                            <label for="username" class="form-label">Ketik Kode</label>
                                            <input type="password" class="form-control form-control-lg" name="rand_code" placeholder="Enter Code" required>
                                        </div>
